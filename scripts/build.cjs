...
async function build(){
 ...
 const files=['css/evolution.css','js/content.js','js/evolution-core.js','js/storage.js','js/art.js','js/audio.js','js/evolution.js','assets/icon.svg','assets/icon-192.png','assets/icon-512.png','assets/icon-maskable.png','manifest.webmanifest'];
