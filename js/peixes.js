...
function showInfoPopup(level) {
  ...
  document.getElementById("info-title").textContent = "🔬 Novo Peixe Descoberto!";
...
function resetCurrentPeixeGame() {
  if (confirm("Deseja reiniciar apenas o nível dos Peixes?")) {
      resetGameForPeixes();
      location.reload();
  }
}
